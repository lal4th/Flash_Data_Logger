@echo off
REM Flash Data Logger v0.9 - Debug Installer (Won't Auto-Close)
REM This version stays open to show errors

title Flash Data Logger v0.9 - Debug Installer

echo ========================================
echo Flash Data Logger v0.9 - Debug Installer
echo ========================================
echo.
echo This installer will stay open to show any errors.
echo.
